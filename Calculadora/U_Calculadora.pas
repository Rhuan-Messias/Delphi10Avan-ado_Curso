...
begin
  ...
  lb_num1.Text := '';
  lb_num2.Text := '';
  // reativar os botões depois de apertar o =
  btn_soma.Enabled := true;
  btn_div.Enabled := true;
  btn_mult.Enabled := true;
  btn_sub.Enabled := true;
