...
begin
  ...
  begin
    Image1.Picture.SaveToFile(dg_salvar.FileName);
  end;
...
begin
// se o dg_text for executado, o arquivo carregado na caixa de diálogo vai ser
// carregado dentro da propriedade Lines do componente Memo1, usando o método
